"use strict";
// Use relative path - works on both localhost and Vercel without CORS issues
// If you need to override for some reason, set NEXT_PUBLIC_API_BASE in environment
